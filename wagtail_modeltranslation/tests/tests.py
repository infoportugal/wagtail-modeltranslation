...
class WagtailModeltranslationTest(TestCase):
    ...
    def test_set_url_path_non_translated_descendants(self):
        ...
        models.TestSlugPage1.objects.filter(
            slug_de__in=["grandchild1-untranslated", "grandgrandchild-untranslated"]
    ...
    def test_fetch_translation_records(self):
        ...
        page = models.StreamFieldPanelPage.objects.create(
            ...
            slug_de="fetch_de",
            slug_en="fetch_en",
            body_de=[("text", "fetch de")],
            body_en=[("text", "fetch en")],
            depth=1,
            path="0007",
        )
        page.save()
    ...
    def test_request_routing(self):
        ...
        site_pages = {
            "model": models.TestRootPage,
            "kwargs": {"title_de": "root routing", "slug_de": "root-routing"},
            "children": {
                "child1": {
                    "model": models.TestSlugPage1,
    ...
    def test_root_page_slug(self):
        site_pages = {
            ...
            "children": {
                ...
                "child3": {
                    "model": models.TestSlugPage2,
                    "kwargs": {"title": "child3 URL", "slug_de": "url-de-03"},
                },
            },
        }
        page_factory.create_page_tree(site_pages)
                        ...
                        "grandchild1": {
                            ...
                            "children": {
                                "grandgrandchild": {
                                    "model": models.TestSlugPage1,
                                    "kwargs": {
                                        "title": "grandgrandchild1 translated",
    ...
    def test_apply_if_live(self):
        ...
        title_field = root.content_panels[0]

        self.assertEqual(title_field.apply_if_live, True)
